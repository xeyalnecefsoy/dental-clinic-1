        ...
        <div className="container grid items-center gap-10 md:grid-cols-2">
          <div>
            <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-slate-900">
              Modern dental care for every smile
            </h1>
            <p className="mt-4 text-slate-600 text-lg">
              Compassionate professionals, advanced technology, and a
              comfortable experience. Your oral health is our priority.
            </p>
            ...
            {[
              {
                ...
                desc: "Preventive exams, cleanings, and personalized hygiene plans.",
                iconSrc: "/icons/tooth.svg",
              },
              {
                slug: "cosmetic-dentistry",
                title: "Cosmetic Dentistry",
                desc: "Whitening, veneers, and bonding for a confident smile.",
                iconSrc: "/icons/star.svg",
              },
              {
                slug: "orthodontics",
                title: "Orthodontics",
                desc: "Clear aligners and braces tailored to your needs.",
                iconSrc: "/icons/tooth.svg",
              },
              {
                slug: "implants",
              ...
              },
              {
                ...
                desc: "Gentle care designed for kids and teens.",
                iconSrc: "/icons/smile.svg",
              },
              {
                slug: "emergency-care",
                title: "Emergency Care",
                desc: "Same-day relief for urgent dental issues.",
              ...
              <a
                ...
                className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition block"
              >
      ...
      <section id="team" className="section">
        <div className="container">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              {
                name: "Dr. Aylin Kaya, DDS",
                role: "General Dentist",
              },
              {
                name: "Dr. Murad Aliyev, DDS",
                role: "Orthodontist",
              },
              {
                name: "Dr. Leyla Hasan, DDS",
      ...
      <section id="testimonials" className="section bg-slate-50">
        <div className="container">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              {
                quote: "The best dental experience I have ever had.",
                name: "Sara",
              },
              {
                quote: "Friendly team and beautiful clinic.",
                name: "Emil",
              },
              {
                quote: "Quick, painless, and professional.",
                name: "Nigar",
              },
            ].map((t) => (
              <figure
      ...
      <section id="booking" className="section">
        <div className="container grid gap-8 md:grid-cols-2 items-center">
          <div>
            ...
            <p className="section-subtitle">
              Fill out the form and our team will contact you to confirm.
            </p>
            <form className="mt-8 grid gap-4">
              ...
              <p className="text-xs text-slate-500">
                Prefer a different time? Use the full form on our booking page.
              </p>
          ...
          <div className="rounded-2xl border border-slate-200 p-6 bg-gradient-to-br from-brand/5 to-white">
            ...
            <p className="mt-2 text-slate-600">
              123 Smile Street, Baku, Azerbaijan
            </p>
            ...
            <a href="#" className="mt-6 inline-flex text-brand hover:underline">
              Get directions
            </a>
          </div>
        </div>
