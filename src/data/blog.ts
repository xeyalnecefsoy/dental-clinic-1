...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt:
      "Simple, effective habits to keep your teeth and gums in top shape every day.",
    content:
    ...
    cover: "/images/blog-hygiene.webp",
  },
  {
    slug: "are-teeth-whitening-safe",
    title: "Are Teeth Whitening Treatments Safe?",
    excerpt:
      "Learn about professional whitening options, safety, and what to expect.",
    content:
    ...
    cover: "/images/blog-whitening.webp",
  },
  {
    ...
    date: "2025-05-10",
    author: "Dr. Murad Aliyev",
    cover: "/images/blog-aligners.jpg",
  },
];
